...
\begin{itemize}
  \item
  \emph{Repository one}: \url{https://www.github/com/organisationthatslong/everslightlytoo-long-repository-name-1}
  \item
  \emph{Repository two}: \url{https://www.github/com/organisationthatslong/everslightlytoo-long-repository-name-2}
  \item
  \emph{Repository three}: \url{https://www.github/com/organisationthatslong/everslightly-too-long-repository-name-3}
\end{itemize}
