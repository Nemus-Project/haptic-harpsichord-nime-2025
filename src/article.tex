...
The haptic key project by Timmermans et al.~\cite{Timmermans2020} began
with the model of a piano key. A 3-key cross-sectional model of a
harpischord mechanism \figure{3key} was provided to the NEMUS project by
...
\figure{teaser}. The sensor system was installed into the full scale
