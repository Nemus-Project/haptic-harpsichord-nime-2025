...
% \begin{figure*}
%     \centering
%     \includegraphics[width=\linewidth]{src/images/bl}
%     \caption{3-Key Model Harpsichord Mechanism designed by Graziano Bandini at San Colombano, Bologna, 2023. Key components include A: Wrestplank, B: Key Lever, C: Key Cap, D: Soundboard, E: Jack.}
%     \label{fig:3key}
% \end{figure*}
...
Finer calibration carried out with the guidance of \anon{Catalina Vincens} as an expert harpsichord performer.
