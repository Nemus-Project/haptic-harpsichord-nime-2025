...
\begin{figure}
    \centering
    \includesvg[inkscapelatex=false, height = 0.4\textheight]{images/log_harp_outline}
    \caption{Logarithmic shape of an original Trasuntino harpsichord}
    \Description{}
    \label{fig:baffles}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{src/images/trasuntino-log-harp.jpg}    
    \caption{Logarithmic shape of an original Trasuntino harpsichord. Source: Image 3 Royal College of Music Collections Item RCM0002  \protect\footnote{\url{https://museumcollections.rcm.ac.uk/collection/Details/collect/58}}  } 
    \Description{}
    \label{fig:baffles}
\end{figure}
