...
\cite{Tagliavini2007} gifted to the museum by the Museum.\\
...
}, which was used as the basis for an interactive exhibition organised by San
Colombano.
...
the model of a piano key. A 3-key cross-sectional model of a harpischord
...
corresponding strings tuned in unison \footnote{"8'-8' È la dispozione normale
...
audio engine. A full scale 49-key scale model was commissioned with
and then built by luthier Roberto Livi in the same style as the 1547 Trasuntino
...
The project was carried out in collaboration with San Colombano. The
