...
The keyboard was commissioned for exhibition where it will act as an interface to  digitised instruments in the collection.  

The project aims to enhance the experiential authenticity of the collection and address how we can conserve the interaction with historical instruments when the interface is a limiting factor in the verisimilitude of the experience.
...
% It also discusses the implications of its execution for installation for public exhibition. 
\end{abstract}
