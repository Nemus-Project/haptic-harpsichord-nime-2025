...
% 16th-century harpsichord keyboard with a typical Renaissance Italian layout to create a DMI. The
% project is a collaboration between the \anon{NEMUS project} and the Museo di San Colombano,
% which houses the Tagliavini Collection of playable historical keyboard instruments. 
% The keyboard was commissioned for exhibition where it will act as an interface to digitised version of historical instruments that are not available to play by visitors.  

% The project aims to enhance the experiential authenticity of the collection and address how we can conserve the interaction with historical instruments when the interface is a limiting factor in the verisimilitude of the experience playing a digitised instrument.

% The tactile feedback of the keyboard is created by incorporating the same mechanics of a two-register harpsichord with a single manual. 
% Unpitched strings under tension replicate the mechanical resistance characteristic of the original compass. 
% An array of optical sensors connected to a microcontroller was installed within the interface to generate continuous
% streams of data corresponding to the vertical motion of each jack. 
% This paper details the keyboard's design principles, technical development, and the motivations behind them. 

This paper describes the design and creation of an electronically augmented replica of a 16th-century harpsichord keyboard with a typical Renaissance Italian layout in order to create a DMI. % [1]
The keyboard was commissioned for exhibition in a musical instrument museum where it will act as an interface to digitised versions of historical instruments that are not in a playable condition. % [2]
