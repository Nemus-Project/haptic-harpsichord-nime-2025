...
% This project embodies the entanglement between musical instrument cultural heritage and its relationship with new and increasing accessible technologies. [3, 4]
% Acknowledgment and conscientiousness to older designs and aesthetics have been used in service of, rather than obstruction to, richer interactions with digital musical instruments.[2,3,4]
% This ultimately culminated in a design for an interface capable of new expressions by extending, rather than forfeiting, the characteristics of the original. % [4]
% We outline the details of the keyboard's design principles, technical development, and the motivations behind them. % [1]
