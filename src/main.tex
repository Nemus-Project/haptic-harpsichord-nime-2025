...
\author{Roberto Livi}
\affiliation{%
  \institution{Master Harpsichord Maker}
  \city{Pesaro}
  \country{Italy}
  }
...
\begin{teaserfigure}
 \centering
  ...
  \Description{An overhead and front view of the replica harpsichord. The overhead view shows the exposed jacks rows, 49 per row and the slant of the bridge and change of sctring from the left to the right.
The front view shows arch detailing on the edge of each key in the same style as is found on early Italian harpsichords.}
  \label{fig:teaser}
\end{teaserfigure}
...
\begin{acks}
The construction of the keyboard received funding from NextGenerationEU within the framework of the accessibility project for the Removal of Physical and Cognitive Barriers in Museums, Libraries and Archives: Sound Heritage No Limits, in the Museum of San Colombano in Bologna - CUP: C38J23000040001 - in the context of PNRR, Mission 1. MH and MD's work was supported by the European Commission's Horizon2020 programme through grant \anon{ERC-StG 950084 NEMUS}. 
...
\item
  ...
  \item
    \emph{uCreate}:    
      Simeon, Stuart, Izzy, and Ruth of uCreate at the Univeristy of
